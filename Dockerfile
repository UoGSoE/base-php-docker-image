...
RUN apt-get update \
    ...
    && apt-get install -y --no-install-recommends tini libfreetype6-dev libjpeg62-turbo-dev libpng-dev libgmp-dev libldap2-dev netcat-traditional curl sqlite3 libsqlite3-dev libzip-dev unzip vim-tiny gosu git \
